...
TextLabel.Text = "Collect Pizza box pressing \"E\" before timer ends. (3.5s)"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 0)
TextLabel.TextSize = 13.000
	wait(1.5)
	TextLabel.Text = "Collect Pizza box pressing \"E\" before timer ends. (2.0s)"
	wait(1)
	TextLabel.Text = "Collect Pizza box pressing \"E\" before timer ends. (1.0s)"
	wait(1)
